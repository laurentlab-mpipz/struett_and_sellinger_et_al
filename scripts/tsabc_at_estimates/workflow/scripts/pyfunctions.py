"""
python functions to help and run the ABC
"""
...
class print_utils:
    """
    print utilities used in the pipeline, mostly for convenience
    """
...
technically an exponential integer refers to a geometric distribution"""
    ...
    def get_list_tmrcas_and_lengths(self, ts, num_pairs_max):
        ...
        tl_table = [[i for i in matrix if not i is None] for matrix in tl_table]
