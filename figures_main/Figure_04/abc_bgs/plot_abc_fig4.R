...
png("sfs_ld_rmu1.tsigma.param_estim.bgs.png", width = 7, height = 7, units = "in", res = 100)
show(p1)
dev.off()
...
png("tm_win_rmu1.tsigma.param_estim.bgs.png", width = 7, height = 7, units = "in", res = 100)
show(p1)
dev.off()
...
png("sfs_ld_tm_win_rmu1.tsigma.param_estim.bgs.png", width = 7, height = 7, units = "in", res = 100)
show(p1)
dev.off()
